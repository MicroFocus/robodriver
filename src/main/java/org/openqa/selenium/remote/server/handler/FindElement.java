// PATCH: see usage io.test.automation.robodriver.internal.RoboElement
...
public class FindElement extends WebDriverHandler<Map<String, String>> {
	...
	public Map<String, String> call() throws Exception {
		try {
			...
			if (element instanceof io.test.automation.robodriver.internal.RoboElement) {
				((io.test.automation.robodriver.internal.RoboElement) element).addKnownElement(elementId);
			}
