 ...
 * @author ooxi
 */
public class DataUri_July2018 { // NOT THE ORIGINAL CLASS NAME: renamed original name 'DataUri' to add used version hint.
	...
	public static DataUri_July2018 parse(String uri, Charset charset) {
		...
		DataUri_July2018 dataURIObject = new DataUri_July2018(
			finalMimeType,
			finalCharset,
			finalFilename,
